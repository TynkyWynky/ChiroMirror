...
-- Install bundle: 20260922000000 through 20260925000300.
-- Includes the legacy profile-column prerequisite and eleven APP migrations.
...
-- Every authenticated account can enter the APP with baseline MEMBER capabilities;
-- create/link member entries and assign elevated roles in the APP UI as needed.
...
begin
  ...
  if to_regclass('supabase_migrations.schema_migrations') is not null then
    execute 'select exists (select 1 from supabase_migrations.schema_migrations where version::text = any($1))'
      into prior_app_history using array['20260922000200', '20260923000100', '20260923000200', '20260923000300', '20260923000400', '20260924000100', '20260924000200', '20260925000100', '20260925000200', '20260925000300', '20260925000400'];
...
-- BEGIN MIGRATION 20260924000200_app_default_access.sql
-- Source SHA-256 (LF): 1bd4b888ab5c37eb948a0acd946e9df7a252379ca7ed1412254e6ef69001a2d8
...
-- END MIGRATION 20260924000200_app_default_access.sql

-- BEGIN MIGRATION 20260925000100_app_role_labels.sql
-- Source SHA-256 (LF): c6e32342ebf85585eafbe888d906b2e7ccda5e7b36697643b5c3ff245dd1d2c2
-- Keep user-facing APP role labels aligned with the Dutch APP terminology.

update public.app_roles
set label = 'Financiën'
where key = 'TREASURER';
-- END MIGRATION 20260925000100_app_role_labels.sql

-- BEGIN MIGRATION 20260925000200_app_role_labels_leiding.sql
-- Source SHA-256 (LF): cfbe6b7e7b7c999cc30d6100c2ea75067cc4abf5a04664f30e7970d9d23b8bf6
...
-- END MIGRATION 20260925000200_app_role_labels_leiding.sql

-- BEGIN MIGRATION 20260925000300_app_baseline_permission_guard.sql
-- Source SHA-256 (LF): 0da029cf8346e01b4e2cc17c5947bdfeb3be4a918b3400437089177d916cb997
...
$$;
-- END MIGRATION 20260925000300_app_baseline_permission_guard.sql

-- BEGIN MIGRATION 20260925000400_app_mask_account_emails.sql
-- Source SHA-256 (LF): 4c8d0392854f17a22fd8926501793978de945bc06773de2dfdc00aaaa84b5899
...
-- END MIGRATION 20260925000400_app_mask_account_emails.sql
